...
async function getRandomMovieByGenre(genre) {
    try {
        ...
        const randomMovieTitle = popularMovies[randomIndex];
        const url = `https://www.omdbapi.com/?apikey=${apiKey}&type=movie&t=${randomMovieTitle}`;
        ...
        if (movie.Response === 'True') {
            ...
            throw new Error('Kein Film gefunden!');
        }
    } catch (error) {
...
function showCheatingWarning() {
    ...
    document.getElementById('game-over-message').innerHTML = `
        ...
        <p>Es sieht so aus, als ob du versucht hast, zu schummeln. Bitte bleib fair!</p>
        <img src="https://img.icons8.com/ios/452/security-checked.png" alt="Schummeln erkannt" style="width: 100px; height: 100px;">
    `;
    questionMusic.pause(); // Frage-Musik stoppen
}
